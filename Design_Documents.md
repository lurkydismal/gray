...
We recommend you use that template so that people can immediately recognize that this is a gray design document and that it is shared publicly.
...
The gray project uses design docs as a tool for guiding discussions.
