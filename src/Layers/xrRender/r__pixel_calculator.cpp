...
void    r_pixel_calculator::begin    ()
{
    ...
    R_CHK            (RDevice->CreateDepthStencilSurface    (rt_dimensions,rt_dimensions, D3DFMT_D24S8,D3DMULTISAMPLE_NONE,0,TRUE,&zb,nullptr));
...
r_aabb_ssa        r_pixel_calculator::calculate    (dxRender_Visual* V)    {
    ...
    for (u32 face=0; face<6; face++)    {
        ...
        mProject.OrthographicOffCenterLH(aabb.min.x, aabb.max.x, aabb.min.y, aabb.max.y, aabb.min.z, aabb.max.z);
