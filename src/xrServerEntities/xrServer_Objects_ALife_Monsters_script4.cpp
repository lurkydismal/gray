...
void ForceSetGoodwill(CSE_ALifeMonsterAbstract *self_, int goodwill, ALife::_OBJECT_ID pWhoToSet)
{
    RELATION_REGISTRY().ForceSetGoodwill(self_->ID, pWhoToSet, goodwill);
}
