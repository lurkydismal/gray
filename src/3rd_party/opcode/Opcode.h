...
// Karlan: ��� ������ ������� ����������� ���, ��� � Prosectors � �������� ���������� � �� ���� ������� ����������� ����������� (��� ��� ����������� �������� ��� ����������� � ODE!)
typedef unsigned int dTriIndex; // Karlan: ������� unsigned short, ���� ����������� ������� ������� � 16 ������ ������� (p.s. � ������� ��������� ����� :))
...
// Preprocessor
    ...
    namespace Opcode
    {
        ...
        FUNCTION OPCODE_API bool InitOpcode(OPCODE_AbortHandler fnAbortHandler=nullptr);
