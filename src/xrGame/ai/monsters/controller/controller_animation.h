...
private:
    ...
    using LEGS_MOTION_MAP_IT = LEGS_MOTION_MAP::iterator;

    using TORSO_MOTION_MAP = xr_map<ETorsoActionType, MotionID>;
    using TORSO_MOTION_MAP_IT = TORSO_MOTION_MAP::iterator;
    ...
    using PATH_ROTATIONS_MAP_IT = PATH_ROTATIONS_MAP::iterator;
