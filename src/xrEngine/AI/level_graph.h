...
public:
    ...
    u32                SearchNearestVertex    (u32 VertexID , const Fvector & TargetPosition, float Range) const;
    ...
    IC        void    unpack_xz                    (const ILevelGraph::CPosition &vertex_position, int &x, int &z) const;
    IC        void    unpack_xz                    (const ILevelGraph::CPosition &vertex_position, float &x, float &z) const;
    template <typename T>
    ...
    IC        const    Fvector                        &vertex_position(Fvector &dest_position, const ILevelGraph::CPosition &source_position) const;
    IC        const    ILevelGraph::CPosition        &vertex_position(ILevelGraph::CPosition &dest_position, const Fvector &source_position) const;
    IC        const    ILevelGraph::CPosition        vertex_position    (const Fvector &position) const;
    ...
    IC        bool    inside                        (const CVertex &vertex, const ILevelGraph::CPosition &vertex_position) const;
    IC        bool    inside                        (const CVertex &vertex, const Fvector &vertex_position) const;
    IC        bool    inside                        (const CVertex *vertex, const ILevelGraph::CPosition &vertex_position) const;
    IC        bool    inside                        (const CVertex *vertex, const Fvector &vertex_position) const;
    IC        bool    inside                        (const u32 vertex_id,    const ILevelGraph::CPosition &vertex_position) const;
    ...
    IC        bool    inside                        (const CVertex &vertex, const ILevelGraph::CPosition &vertex_position, const float epsilon) const;
    IC        bool    inside                        (const CVertex &vertex, const Fvector &vertex_position, const float epsilon) const;
    IC        bool    inside                        (const CVertex *vertex, const ILevelGraph::CPosition &vertex_position, const float epsilon) const;
    IC        bool    inside                        (const CVertex *vertex, const Fvector &vertex_position, const float epsilon) const;
    IC        bool    inside                        (const u32 vertex_id,    const ILevelGraph::CPosition &vertex_position, const float epsilon) const;
    ...
    IC        float    vertex_high_cover            (const ILevelGraph::CVertex *vertex) const;
    IC        float    vertex_low_cover            (const ILevelGraph::CVertex *vertex) const;
    ...
    IC        const u32 vertex_id                    (const ILevelGraph::CVertex *vertex) const;
