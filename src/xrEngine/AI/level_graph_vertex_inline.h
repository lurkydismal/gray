...
IC float ILevelGraph::distance(const Fvector &position, const Fvector &point0, const Fvector &point1) const
{
    Fvector                c, V;
...
IC void ILevelGraph::project_point(const Fplane &plane, Fvector &point) const
{
    point.y                -= plane.classify(point)/plane.n.y;
}

IC float ILevelGraph::distance(u32 vertex_id0, u32 vertex_id1) const
{
    return                (distance(vertex(vertex_id0),vertex(vertex_id1)));
}

IC float ILevelGraph::distance(const ILevelGraph::CVertex *_node, u32 vertex_id1) const
{
    return                (distance(_node,vertex(vertex_id1)));
}

IC float ILevelGraph::distance(u32 vertex_id0, const ILevelGraph::CVertex *_node) const
{
    return                (distance(vertex(vertex_id0),_node));
}

IC float ILevelGraph::distance(const ILevelGraph::CVertex *node0, const ILevelGraph::CVertex *node1) const
{
    return                (vertex_position(node0).distance_to(vertex_position(node1)));
}

IC float ILevelGraph::distance(const Fvector &position, const u32 vertex_id) const
{
    return                (distance(position,vertex(vertex_id)));
}

IC float ILevelGraph::distance(const u32 vertex_id, const Fvector &position) const
{
    return                (distance(position,vertex_id));
}

IC float ILevelGraph::distance(const u32 vertex_id, const CPosition &position) const
{
    return                (distance(vertex_position(position),vertex_id));
}

IC float ILevelGraph::distance(const CPosition &position, const u32 vertex_id) const
{
    return                (distance(vertex_position(position),vertex_id));
}

IC ILevelGraph::ELineIntersections  ILevelGraph::intersect( 
...
IC void ILevelGraph::intersect(SSegment &tSegment, const SContour &tContour0, const SContour &tContour1) const
{
    bool bFound = false;
...
IC float ILevelGraph::nearest(Fvector& Dest, const Fvector& P, const Fvector& A, const Fvector& B) const
{
...
IC void ILevelGraph::contour(ILevelGraph::SContour &_contour, u32 vertex_id) const
{
...
IC float ILevelGraph::nearest(Fvector &destination, const Fvector &position, const ILevelGraph::SContour &contour) const
{
...
IC bool ILevelGraph::intersect(Fvector& dst, const Fvector& v1, const Fvector& v2, const Fvector& v3, const Fvector& v4) const
{
...
IC    float ILevelGraph::square(float a1, float b1, float fAlpha) const
{
...
IC    float ILevelGraph::compute_square(float fAngle, float fAngleOfView, float b1, float b0, float b3, float b2) const
{
...
IC    float ILevelGraph::compute_high_square(float fAngle, float fAngleOfView, const ILevelGraph::CVertex *vertex) const
{
    return(
        compute_square(
            fAngle, 
...
IC    float ILevelGraph::compute_low_square(float fAngle, float fAngleOfView, const ILevelGraph::CVertex *vertex) const
{
    return(
        compute_square(
            fAngle, 
...
IC    float ILevelGraph::compute_high_square(float fAngle, float fAngleOfView, u32 dwNodeID) const
{
    return(compute_high_square(fAngle, fAngleOfView,vertex(dwNodeID)));
}

IC    float ILevelGraph::compute_low_square(float fAngle, float fAngleOfView, u32 dwNodeID) const
{
    return(compute_low_square(fAngle, fAngleOfView,vertex(dwNodeID)));
}

IC    float ILevelGraph::vertex_high_cover(const ILevelGraph::CVertex *vertex) const
{
    float            _cover = 0.f;
...
IC    float ILevelGraph::vertex_low_cover(const ILevelGraph::CVertex *vertex) const
{
    float            _cover = 0.f;
...
IC    float ILevelGraph::vertex_high_cover(const u32 vertex_id) const
{
    return            (vertex_high_cover(vertex(vertex_id)));
}

IC    float ILevelGraph::vertex_low_cover(const u32 vertex_id) const
{
    return            (vertex_low_cover(vertex(vertex_id)));
}

IC    float ILevelGraph::high_cover_in_direction(float angle, const ILevelGraph::CVertex *vertex) const
{
    return                (
        cover_in_direction(
            angle,
...
IC    float ILevelGraph::low_cover_in_direction(float angle, const ILevelGraph::CVertex *vertex) const
{
    return                (
        cover_in_direction(
            angle,
...
IC    float ILevelGraph::high_cover_in_direction(float angle, u32 vertex_id) const
{
    return                (high_cover_in_direction(angle, vertex(vertex_id)));
}

IC    float ILevelGraph::low_cover_in_direction(float angle, u32 vertex_id) const
{
    return                (low_cover_in_direction(angle, vertex(vertex_id)));
}

IC    u32     ILevelGraph::check_position_in_direction    (u32 start_vertex_id, const Fvector2 &start_position, const Fvector2 &finish_position) const
{
...
IC    bool ILevelGraph::check_vertex_in_direction        (u32 start_vertex_id, const Fvector2 &start_position, u32 finish_vertex_id) const
{
...
IC    u32 ILevelGraph::check_position_in_direction(u32 start_vertex_id, const Fvector &start_position, const Fvector &finish_position) const
{
...
IC    bool ILevelGraph::check_vertex_in_direction(u32 start_vertex_id, const Fvector &start_position, u32 finish_vertex_id) const
{
    return                    (check_vertex_in_direction(start_vertex_id,Fvector2().set(start_position.x,start_position.z),finish_vertex_id));
}

template <class _predicate>
float ILevelGraph::vertex_high_cover_angle(u32 vertex_id, float inc_angle, _predicate compare_predicate) const
{
...
template <class _predicate>
float ILevelGraph::vertex_low_cover_angle(u32 vertex_id, float inc_angle, _predicate compare_predicate) const
{
    float best_angle    = 0.f;
