...
//            .def("vector_on_draw",            &CScriptPropertiesListHelper::FvectorRDOnDraw)
            .def("float_on_after_edit",        &CScriptPropertiesListHelper::floatRDOnAfterEdit, out_value<3>())
            .def("float_on_before_edit",    &CScriptPropertiesListHelper::floatRDOnBeforeEdit, out_value<3>())
//            .def("float_on_draw",            &CScriptPropertiesListHelper::floatRDOnDraw)
            .def("name_after_edit",            &CScriptPropertiesListHelper::NameAfterEdit, pure_out_value<3>())
            .def("name_before_edit",        &CScriptPropertiesListHelper::NameBeforeEdit, pure_out_value<3>())
