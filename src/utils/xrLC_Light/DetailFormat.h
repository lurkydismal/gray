...
class DetailHeader
{
    ...
    u32        size_x,    size_z;
public: 
    DetailHeader(): _version(u32(-1)), object_count( u32(-1) ), offs_x(u32(-1)), offs_z( u32(-1) ), 
                    size_x( u32(-1) ), size_z( u32(-1) ){}
...
{
    return pallete.a0 == 0 && pallete.a1 == 0 && pallete.a2 == 0 && pallete.a3 == 0;
}
