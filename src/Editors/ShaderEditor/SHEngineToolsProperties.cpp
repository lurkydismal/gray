...
void  CSHEngineTools::MCOnDraw(PropValue* sender, xr_string& draw_val)
{
...
//---------------------------
    ...
    Ext.m_ItemProps->SetModifiedEvent(TOnModifiedEvent(this,&CSHEngineTools::Modified));
}
//------------------------------------------------------------------------------
