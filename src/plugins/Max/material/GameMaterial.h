...
public:
    ...
    static LPSTR_vec            EShaders;
    static LPSTR_vec            CShaders;
    static LPSTR_vec            GameMtls;
    ...
    void SetShaderIndx( int shaderId, BOOL update=TRUE );
    ...
    void SetEShaderIndx(int shaderId);
    void SetCShaderIndx(int shaderId);
    void SetGameMtlIndx(int shaderId);
    long GetEShaderIndx(){ return eshaderId; }
    long GetCShaderIndx(){ return cshaderId; }
    long GetGameMtlIndx(){ return gamemtlId; }
    LPCWSTR GetEShaderName(){ return GetEShader(eshaderId); }
    LPCWSTR GetCShaderName(){ return GetCShader(cshaderId); }
    LPCWSTR GetGameMtlName(){ return GetGameMtl(gamemtlId); }
    ...
    void SetSamplerIndx(int indx, BOOL update=TRUE );
    ...
    RefTargetHandle Clone(const RemapDir &remap = DefaultRemapDir());
